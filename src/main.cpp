...
void TheNextWeekFinalScene(int image_width, int samples_per_pixel, int max_depth) {
  HittableList boxes1;
...
int main() {
  ...
  switch (11) {
    ...
    case 10: TheNextWeekFinalScene(800, 10000, 40); break; // sweet dreams
    case 11: TheNextWeekFinalScene(400, 250, 4); break;
  }
  // clang-format on
}
